        ...
        <div class="row page-titles m-b-30">
            ...
            <div class="col-md-7 align-self-center">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Исходящие</li>
                </ol>
            </div>
        </div>
        <!-- ============================================================== -->
                            ...
                            <div class="col-xlg-2 col-lg-3 col-md-4">
                                <div class="card-body inbox-panel">
                                    ...
                                    <ul class="list-group list-group-full">
                                        <li class="list-group-item"> <a href="/mail/inbox"><i class="mdi mdi-gmail"></i> Входящие
                                                <? if ($data['internalMailStats']['inbox_new'] > 0) :?>
                                                    <span class="badge badge-success ml-auto"><?=$data['internalMailStats']['inbox_new']?></span>
                                                <? endif; ?>
                                            </a></li>
                                        <li class="list-group-item active"><a href="/mail/outbox"> <i class="mdi mdi-file-document-box"></i> Исходящие </a></li>
                                    </ul>
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-10 btn-group m-b-10" aria-label="Button group with nested dropdown">
                                            <a href="/mail/outbox" class="btn btn-secondary m-r-10 m-b-10"><i class="mdi mdi-reload font-18"></i> Обновить</a>
                                        ...
                                        <div class="inbox-center table-responsive">
                                            <table class="table table-hover no-wrap">
                                                ...
                                                <tr class="unread">
                                                    ...
                                                    <? if ($message->isReceiverInContacts()): ?>
                                                        text-info
                                                    <? elseif ($message->isReceiverIsAdmin()): ?>
                                                        text-warning
                                                     <? else: ?>
                                                        text-danger
                                                    <? endif; ?>
                                                    "></i></td>
                                                    <td class="hidden-xs-down"><a href="/user/profile/<?=$message->getIdReceiver();?>"><?=htmlspecialchars($message->getReceiverFio());?></a></td>
                                                    <td class="max-texts"> <a href="/mail/show/<?=$message->getId();?>">
                                                            <? if (trim($message->getTimeReceived()) == ''): ?>
                                                                <span class="label label-primary m-r-10">Непрочтенное</span>
                                                            <? endif;?>
